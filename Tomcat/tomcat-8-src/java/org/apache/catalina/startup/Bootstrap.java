...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        // 因为 每个运行中的线程都有一个 ClassLoader，并且会从父线程中继承（默认是应用类加载器），
        ...
        // 反射方法实例化Catalina，后面初始化Catalina用了很多反射，不知道意图是什么?? TODO
   ...
   /**
    ...
    public static void main(String args[]) {
        ...
        if (daemon == null) {
            ...
            try {
                //1、初始化各种ClassLoader：commonLoader、catalinaLoader、sharedLoader
                //2、通过反射实例化 Catalina对象，并设置父ClassLoader为 sharedLoader
                bootstrap.init();
            } catch (Throwable t) {
                handleThrowable(t);
                t.printStackTrace();
